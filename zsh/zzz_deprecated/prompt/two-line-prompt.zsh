...
function set-prompt() {
  ...
  local top_left='%F{blue}TESTTL%~%f'
  local top_right="%F{green}TESTTR${git_branch}%f"
  local bottom_left='%BTESTBL%F{%(?.green.red)}%#%f%b '
  local bottom_right='%F{yellow}TESTBR%T%f'
