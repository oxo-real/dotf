...
## fzf default options
export FZF_DEFAULT_OPTS='--cycle --layout reverse --tiebreak length,begin,index --info inline:'∑=' --height ~25% --bind esc:cancel --preview "tree -L 1 {}" --preview-window :hidden --scrollbar '' --no-unicode --color dark,fg:#999999,hl:#ffffff,hl+:#ffffff,bg+:#333333,info:#96cbfe,prompt:#96cbfe,pointer:#ffffd3,query:#999999,marker:#a8ff60,separator:#111111,spinner:#000000'
