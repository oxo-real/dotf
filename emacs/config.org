...
#+begin_src emacs-lisp
  ...
  (defun oxo/org-present-start ()
    ...
    (setq-local face-remapping-alist '((default (:height 125.5) fixed-pitch)
                (header-line (:height 125.0) fixed-pitch)
                (org-document-title (:height 125.75) org-document-title)
                (org-code (:height 125.55) org-code)
                (org-verbatim (:height 125.55) org-verbatim)
                (org-block (:height 125.25) org-block)
                (org-block-begin-line (:height 125.7) org-block)))
