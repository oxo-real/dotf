...
#+begin_src emacs-lisp
  ...
  (defun oxo/org-present-start ()
    ...
    (setq-local face-remapping-alist '((default (:height 115.5) fixed-pitch)
                (header-line (:height 115.0) fixed-pitch)
                (org-document-title (:height 115.75) org-document-title)
                (org-code (:height 115.55) org-code)
                (org-verbatim (:height 115.55) org-verbatim)
                (org-block (:height 115.25) org-block)
                (org-block-begin-line (:height 115.7) org-block)))
