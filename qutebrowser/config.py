...
## read from JavaScript is always the global value.
## Type: FormatString
c.content.headers.user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 Edg/119.0.0.0'
...
## Type: Padding
c.tabs.padding = {'top': 0, 'bottom': 0, 'left': 6, 'right': 2}
